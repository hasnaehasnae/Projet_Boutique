...
namespace Proxies\__CG__\Utilisateurs\UtilisateurBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Utilisateurs extends \Utilisateurs\UtilisateurBundle\Entity\Utilisateurs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'cmds', 'adresses', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function addAdress(\Ecommerce\EcommerceBundle\Entity\Adresse $adresses)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAdress', [$adresses]);
