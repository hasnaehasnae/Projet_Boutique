...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ecommerce', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Ecommerce\\EcommerceBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Utilisateurs\\UtilisateurBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Ecommerce\\EcommerceBundle\\Entity');
        $c->addDriver($b, 'Utilisateurs\\UtilisateurBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('EcommerceBundle' => 'Ecommerce\\EcommerceBundle\\Entity', 'UtilisateurBundle' => 'Utilisateurs\\UtilisateurBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_44a0960b5a991d6689561b5bc90afc609b72dc9a5fa1fe85fa88c6740683bb87');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Utilisateurs\\UtilisateurBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Utilisateurs\\UtilisateurBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Utilisateurs\\UtilisateurBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Utilisateurs\\UtilisateurBundle\\Entity\\Utilisateurs');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Utilisateurs\\UtilisateurBundle\\Entity\\Utilisateurs');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Ecommerce\\EcommerceBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Utilisateurs\\UtilisateurBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Ecommerce\\EcommerceBundle/Resources/views'), 'Ecommerce');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UtilisateurBundle' => 'Utilisateurs\\UtilisateurBundle\\UtilisateurBundle',
            ...
            'fos_user.model.user.class' => 'Utilisateurs\\UtilisateurBundle\\Entity\\Utilisateurs',
